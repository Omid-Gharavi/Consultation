...
const Content = () => {
    ...
    return (
        <>
            ...
            <div className='min-h-[96px] bg-[#473BF0] flex flex-wrap p-4 justify-center items-center gap-2'>
                ...
                <p className='text-white max-lg:text-center'>We’ve added a new exciting feature in v3.0. <Link className='underline' href={'#'}>Get it now for $49</Link>.</p>
            </div>
        </>
    )
}
